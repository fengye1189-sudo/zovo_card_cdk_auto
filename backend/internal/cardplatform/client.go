...
func New(cfg Config) *Client {
	return &Client{
		cfg:    cfg,
		client: NewIPv4HTTPClient(defaultHTTPTimeout),
	}
}

// NewIPv4HTTPClient keeps CardPlatform requests on IPv4. The service's API-key
// allowlist is normally configured with the VPS IPv4 address; letting a dual-
// stack host prefer IPv6 would otherwise cause a valid key to be rejected.
