    ...
    <div class="card space-y-4">
      ...
      <el-form label-position="top" :disabled="!ready || saving">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <el-form-item label="自动补充已勾选卡的余额"><el-switch v-model="settings.topup_enabled" /><p class="hint">付款结果已确认且余额低于阈值时可再次补款；有在途或待核对订单、资金未确认时不补款。仍受每日预算和单次上限限制；Pro 成功入池卡不会自动补款。</p></el-form-item>
